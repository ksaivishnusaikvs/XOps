# Terraform Module: VPC with Best Practices
# Demonstrates reusable, secure, and well-documented module structure
...
variable "single_nat_gateway" {
  description = "Use single NAT gateway for cost savings (not recommended for prod)"
  type        = bool
  default     = false
}
